...
urlpatterns = [
    ...
    path('search_expenditure/', expenditure_views.filter_by_title, name='search_expenditure'),
    path('search_category/', expenditure_views.filter_by_category, name='search_category'),
