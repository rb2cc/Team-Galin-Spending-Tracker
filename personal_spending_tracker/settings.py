"""
Django settings for personal_spending_tracker project.
...
SECRET_KEY = 'django-insecure-q$!g&aae6tvzz9uxm#$$#8fwns-j5wdn=-+b6ss*raqs=qod4x'
...
WSGI_APPLICATION = 'personal_spending_tracker.wsgi.application'
...
CRONJOBS = [
    ...
    ('1 9 * * */1', 'tracker.cron.category_progress_notification_cron_job'), #runs everyday at 9:01
    ('0 0 1 * *', 'tracker.cron.delete_binned_objects_cron_job')#runs at 00:00 on the first day of every month
